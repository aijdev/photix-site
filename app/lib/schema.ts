...
/** Organization schema for the AI Journey company behind Photix. */
...
export function softwareAppSchema(overrides?: {
  ...
  return {
    ...
    name: overrides?.name ?? "Photix — AI Image Generator, Editor & Avatars",
    ...
    image: ORG.logo,
    screenshot: [
      `${SITE_URL}/shots/screen-0.jpg`,
      `${SITE_URL}/shots/screen-3.jpg`,
      `${SITE_URL}/shots/screen-5.jpg`,
    ],
