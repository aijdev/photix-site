...
export function AiPhotoEditorView({ locale }: { locale: Locale }) {
  const feature = getFeature("ai-photo-editor", locale)!;
  const d = getDictionary(locale);
  const p = d.toolPages.aiPhotoEditor;
    ...
    <>
      ...
      <Section>
        <SectionHeading
          ...
          title={p.examplesTitle}
          description={p.examplesDescription}
        />
      ...
      <RelatedFeatures currentSlug="ai-photo-editor" locale={locale} />
